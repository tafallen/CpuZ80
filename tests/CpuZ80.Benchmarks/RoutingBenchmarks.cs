...
/// </summary>
/// <remarks>
/// This is a REGRESSION GUARD rather than a target. The review measured the
/// decoder at only ~1.03x the cost of a flat array under real code — Z80
/// programs have strong address locality, so the 1 MiB routing table stays hot
/// in cache. The random-access pair below is the adversarial case (~2x) and
/// exists to show what the decoder would cost if a future machine ever started
